...
export const authCopy: Record<LandingLocale, AuthCopy> = {
  tr: {
    ...
    login: {
      ...
      rememberMeHint: '30 gün oturum açık kalır; kullanıcı adı ve şifre bu cihazda kaydedilir.',
  ...
  en: {
    ...
    login: {
      ...
      rememberMeHint: 'Stay signed in for 30 days; username and password are saved on this device.',
